...
sleep 2
mv /tmp/dumps /mnt/storage1/football_dataset/academy_corner
sleep 2
...
sleep 2
mv /tmp/dumps /mnt/storage1/football_dataset/academy_counterattack_easy
sleep 2
...
sleep 2
mv /tmp/dumps /mnt/storage1/football_dataset/academy_counterattack_hard
sleep 2
...
sleep 2
mv /tmp/dumps /mnt/storage1/football_dataset/11_vs_11_competition
sleep 2
...
sleep 2
mv /tmp/dumps /mnt/storage1/football_dataset/11_vs_11_easy_stochastic
